...
public class TouchTest extends BaseTest {
	...
	public void canCreateShortTouch() {
		...
		Assert.assertTrue("getMusicalQualities correctly doesn't include a record for '135246'",
...
/*	@Test
	public void canCreateTouchWithDifferentStages() {

		Touch touch = new Touch();

		Method pbm = super.createPlainBobMinorMethod();
		Method ssd = super.createStSimonsDoublesMethod();
		Call bob = new Call("B", "14");
		Call plain = new Call();

		ssd.applyYourselfTo(touch);
		plain.applyYourselfTo(touch);
		pbm.applyYourselfTo(touch);
		plain.applyYourselfTo(touch);
