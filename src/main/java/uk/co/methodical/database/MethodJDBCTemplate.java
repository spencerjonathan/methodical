...
public class MethodJDBCTemplate implements MethodDAO {
	...
	public static MethodJDBCTemplate instance() {
		...
		if (self == null) {
			...
			if (env.get("OPENSHIFT_MYSQL_DB_HOST") != null &&
					env.get("OPENSHIFT_MYSQL_DB_PORT") != null) {
				
				String url = "jdbc:mysql://" + 	env.get("OPENSHIFT_MYSQL_DB_HOST") + ":" + env.get("OPENSHIFT_MYSQL_DB_PORT") + "/methodical";
